...
class DiagnosticsReportTest {
    ...
    fun reportIncludesSimDetails() {
        val text = DiagnosticsReport.format(device, app, 7, true, true, 2, sims, display, 0L)
    ...
    fun reportIncludesDisplayModes() {
        val text = DiagnosticsReport.format(device, app, -1, false, false, 1, emptyList(), display, 0L)
